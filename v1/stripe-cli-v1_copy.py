...
from functions import invoiceScript, paymentVerification, proxyDistributer, gmailSender
numberOfRows = 0
invoice_count = 0
            ...
            if invoice_list != []:
                for i in invoice_list:
                    ...
                    if hasPaid == True:
                        ...
                        proxyList = proxyDistributer(customer_email, qty)
                        gmailSender(customer_email, proxyList, qty, productType)
                        ...
                        with open('active-proxies.json') as json_file: 
                            ...
                            update = {f"{customer_email}": f'{proxyList}'} 
                            temp.append(update)
                        write_json(data)
